...
2. [BACKLOG.md](BACKLOG.md) — pick `TASK-00N` if implementing
3. [DATA-CONTRACTS.md](contracts/DATA-CONTRACTS.md) — required for STATE, ledger, config work
4. **One LLD** for the task:
