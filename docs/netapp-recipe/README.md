...
| `recipe-install [--target <path>] [--uninstall]` (TASK-031) | Re-run after skills already exist. **First install on a clone:** bash runner in [CLONE.md](CLONE.md), not this skill — [.gsd-recipe/templates/recipe-install-SKILL.md](../../.gsd-recipe/templates/recipe-install-SKILL.md) · [report](../../bench/report/recipe-install-integration-report.md) |
