...
3. **TASK-040** — Unify install front door (one-page decision tree)
4. **TASK-041** — Team clone / reinstall playbook
...
11. **TASK-044** — Install doctor (MCP paste, `recipe_source`, Jira verify collapse)
