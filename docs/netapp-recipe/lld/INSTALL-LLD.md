...
```
.templates/                    # committed — recipe templates
  PRD.template.md
  SPEC.template.md
  TDD.template.md
...
```
.knowledge/                    # committed — OKF v0.1 bundle [E]
...
code_base_details/             # committed — human-authored repo context
...
.planning/                     # GSD native [N]

.gsd-recipe/                # recipe metadata (committed)
...
All committed knowledge files under `.knowledge/` and promoted playbooks use [Open Knowledge Format v0.1](https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md):
...
| 7 | Gitignore | `.learnings/`, `.gsd-codebase/` ignored | [C] |
