...
lines.append("")
lines.append("`recipe-prd-intake` and `recipe-onboard` accept a Jira/Confluence PRD export, an already-canonical PRD, pasted text, or a freeform description.")
lines.append("")
...
lines.append("- Examples: `recipe-prd-intake @path/to/jira-prd.md` or `recipe-onboard @path/to/jira-prd.md`.")
lines.append("")
