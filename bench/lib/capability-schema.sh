...
CATALOG = [
    ...
    },
    {
        ...
        "task_id": "TASK-034",
        "kind": "cursor-skill",
        "description": "Agent-mediated phase-task creation: detect then list, resolve issue type, assign via lookupJiraAccountId, confirm, then per pending phase createJiraIssue (assignee_account_id) + link + To Do transition, then mark-done/mark-failed.",
